...
public class Ex4_배열 {
	public static void main(String[] args) {
		...
		// 1. p_168
			// String 변수 여러 개를 저장할 수 있는 String 배열 선언
			...
			System.out.println("배열 1 : " + season[0]);
			System.out.println("배열 2 : " + season[1]);
			System.out.println("배열 3 : " + season[2]);
			System.out.println("배열 4 : " + season[3]);
			// System.out.println("배열 5 : " + season[4]); 
				// -> 오류발생 : 인덱스 없음
