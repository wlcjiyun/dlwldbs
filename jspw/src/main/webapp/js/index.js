...
function product_print(){
	...
	productList.forEach( (o,i) => {
		html += `
				<div class="item">
					<img alt="" src="img/${o.img}">
					<div class="item_info">
						<div class="item_title">${o.title}</div>
						<div class="item_size">${o.size}</div>
						<div class="item_price">${o.price.toLocaleLowerCase()}원</div>
						<div>
					...
					<div class="item_bottom">
						<div>
							...
							<span class="badge rounded-pill text-bg-danger">인기상품</span>
						</div>
						<div class="item_review">찜 ${o.like} | 리뷰 ${o.rivew}</div>
					</div>
				</div>
				`
	})		
